...
//Las variables Multiple
var respuestaMultiple = [];
var respuestaMultiple1 = [];

//Las variables Checkbox
...
window.onload = function(){ 
 ...
 formElement.onsubmit=function(){
   ...
   inicializar();
   //Funciones de correccion de Text
   corregirText();
   corregirText1();
   
    //Funciones de correccion de checkbox
   corregirCheckbox(); 
   corregirCheckbox1()
   
   //Funcionesd de correccion de select
   corregirSelect();
   corregirSelect1();

   //Funciones de correccion select
   corregirRadio();
   corregirRadio1();
  
  //Funciones de correccion de Multiple
   corregirMultiple();
   corregirMultiple1();
  
//Funcion de nota final
  presentarNota();
   return false;
 }
 ...
 xhttp.open("GET", "https://rawgit.com/jordanfast/FormularioBuena/master/xml/Preguntas_XML.xml", true); 
 xhttp.send();
}
